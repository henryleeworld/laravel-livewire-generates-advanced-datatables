                            ...
                            @else
                                @if (method_exists($paginator, 'getCursorName'))
                                    <button
                                        ...
                                        class="select-none p-2 m-1 text-center text-white bg-pg-primary-600 border-pg-primary-400 rounded-sm cursor-pointer border-1 hover:bg-pg-primary-600 hover:border-pg-primary-800 dark:text-pg-primary-300"
                                    >
                                        <svg
                                            fill="none"
                                            viewBox="0 0 24 24"
